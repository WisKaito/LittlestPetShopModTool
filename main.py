# -*- coding: utf-8 -*-
# Littlest Pet Shop Mod Tool — improved signature handling and name extraction
# Python 2.7.18
...
class LPSModTool(tk.Tk):
    ...
    def export_fsh(self):
        ...
        if not out:
            return
        # Trim to include up to null terminator (name_end_rel) — this removes trailing padding bytes
        if b.name_end_rel is not None:
            trimmed = b.data[:b.name_end_rel+1]
        else:
            trimmed = b.data
